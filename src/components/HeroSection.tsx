    ...
    <section className="relative min-h-screen w-full overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 w-full h-full z-0">
        ...
        <video
          ...
          muted
          playsInline
          className={`object-cover w-full h-full transition-opacity duration-1000 relative ${
      ...
      {/* Botão + Mascote tipo adesivo */}
      <div className="fixed bottom-5 right-20 sm:bottom-10 sm:right-10 z-30 flex items-end">
        <div className="relative">
          {/* Mascote estilo adesivo por trás */}
          <div className="absolute bottom-0 right-4/2 translate-x-6 z-10 pointer-events-none">
            <img
              src="/imgs/mascote.png"
              alt="Mascote Hazap"
              className="w-28 sm:w-36 md:w-40 lg:w-44 drop-shadow-2xl"
            />
          </div>

          {/* Botão principal na frente */}
          <button
            onClick={scrollToMachines}
            className="relative z-20 flex items-center justify-center bg-gradient-to-r from-orange-500 to-orange-700 hover:from-orange-600 hover:to-orange-800 px-4 py-4 rounded-xl border-2 border-orange-400 shadow-2xl transition-all duration-300 hover:scale-105 group min-w-[220px] sm:min-w-[240px]"
          >
